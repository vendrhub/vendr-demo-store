                ...
                return {
                    ...
                    bulkAction: function (items, config) {
                        return $q(function (resolve, reject) {
                            ...
                            editorService.open({
                                view: '/App_Plugins/Vendr/backoffice/views/dialogs/printoptions.html',
                                config: {
                                    storeId: items[0].storeId,
                ...
                return {
                    ...
                    bulkAction: function (items, config) {
                        return $q(function (resolve, reject) {
                            ...
                            editorService.open({
                                view: '/App_Plugins/Vendr/backoffice/views/dialogs/export.html',
                                size: 'small',
                                config: {
                                    storeId: items[0].storeId,
                                    entityType: items[0].entityType,
                    ...
                    action: function (model) {
                        return $q(function (resolve, reject) {
                            ...
                            var sendEmailDialogOptions = {
                                view: '/App_Plugins/Vendr/backoffice/views/dialogs/sendemail.html',
                                size: 'small',
                                config: {
                                    storeId: model.storeId,
                            ...
                            var pickEmailTemplateDialogOptions = {
                                view: '/App_Plugins/Vendr/backoffice/views/dialogs/emailtemplatepicker.html',
                                size: 'small',
                                config: {
                                    storeId: model.storeId,
